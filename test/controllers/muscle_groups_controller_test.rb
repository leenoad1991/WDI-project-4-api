...
class MuscleGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create muscle_group" do
    assert_difference('MuscleGroup.count') do
      post muscle_groups_url, params: { muscle_group: { description: @muscle_group.description, image: @muscle_group.image, name: @muscle_group.name } }, as: :json
    end
  ...
  test "should update muscle_group" do
    patch muscle_group_url(@muscle_group), params: { muscle_group: { description: @muscle_group.description, image: @muscle_group.image, name: @muscle_group.name } }, as: :json
    assert_response 200
  end
